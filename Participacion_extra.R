...
#    Agrupan los valores para la variable Sepal.Width 
#    y se calcula la frecuencia absoluta.

tabla_PL<-as.data.frame(table(PL = iris$Sepal.Width))


# 2.- Frecuencia absoluta de la variable Sepal.Width (PL)
...
# 7.- Organización visual de la tabla (variable Sepal.Width)
